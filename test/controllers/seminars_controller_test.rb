...
class SeminarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seminar" do
    assert_difference('Seminar.count') do
      post seminars_url, params: { seminar: { date: @seminar.date, seminar_type_id: @seminar.seminar_type_id } }
    end
  ...
  test "should update seminar" do
    patch seminar_url(@seminar), params: { seminar: { date: @seminar.date, seminar_type_id: @seminar.seminar_type_id } }
