...
class RegistrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registration" do
    assert_difference('Registration.count') do
      post registrations_url, params: { registration: { guide_id: @registration.guide_id, seminar_id: @registration.seminar_id } }
    end
  ...
  test "should update registration" do
    patch registration_url(@registration), params: { registration: { guide_id: @registration.guide_id, seminar_id: @registration.seminar_id } }
